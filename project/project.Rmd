...
We perform linear regression of a car's MPG on its weight. We will use the `lm()` function to fit a linear model, and the `summary()` function to get a summary of the linear model.
